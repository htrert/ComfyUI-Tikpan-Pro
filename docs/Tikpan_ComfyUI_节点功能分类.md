...
> 更新日期：2026-06-09  
> 当前口径：根目录 `__init__.py` 已注册 52 个节点，菜单分为 7 类。
...
- `视频｜Grok3 直出视频生成`
- `视频｜Grok-Videos 视频生成`
- `视频｜Kling Motion Control 动作控制`（v2.6/v3，使用 `image_url` / `video_url`）
- `视频｜MiniMax Hailuo 视频生成`（Hailuo-2.3 / Hailuo-02）
- `视频｜Kling 文生视频`
- `视频｜Kling 图生视频`
- `视频｜Vidu3 参考生视频`
...
用于从素材中反推提示词、分析视频结构、重构脚本、管理提示词库和优化生成描述。
...
- 福利渠道、活动渠道、定制活动生图：放入 `07 福利 Benefit`。
