...
from .nodes.tikpan_cangyuan_gpt_image_2 import TikpanCangyuanGptImage2Node
from .nodes.tikpan_cangyuan_grok_video_15 import TikpanCangyuanGrokVideo15Node
from .nodes.tikpan_cangyuan_video_models import (
...
NODE_CLASS_MAPPINGS = {
    ...
    "TikpanCangyuanGptImage2Node": TikpanCangyuanGptImage2Node,
    "TikpanCangyuanGrokVideo15Node": TikpanCangyuanGrokVideo15Node,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "TikpanGptImage2GenNode": "图片｜GPT-Image-2-C 旧版多参考生图",
    "TikpanGptImage2EditNode": "图片｜GPT-Image-2-C 旧版修图",
    "TikpanGptImage2BenefitNode": "图片｜GPT-Image-2 福利生图",
    "TikpanGrokVideo15BenefitNode": "福利｜Grok Video 1.5 单图生视频",
    "TikpanCangyuanGptImage2Node": "new.ip233.com｜GPT-Image-2 生图",
    "TikpanCangyuanGrokVideo15Node": "new.ip233.com｜Grok Video 1.5 单图生视频",
